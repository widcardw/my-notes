...
\tan\varphi&={{A_1\sin\left(\varphi_1-\displaystyle{2\pi r_1\over\lambda}\right)+A_2\sin\left(\varphi_2-\displaystyle{2\pi r_2\over\lambda}\right)}\over{A_1\cos\left(\varphi_1-\displaystyle{2\pi r_1\over\lambda}\right)+A_2\cos\left(\varphi_2-\displaystyle{2\pi r_2\over\lambda}\right)}}\\
