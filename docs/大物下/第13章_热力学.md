...
$$
\begin{aligned}
C_{p}={\mathrm{d}Q_{p}\over\mathrm{d}T}&={\mathrm{d}E+p\mathrm{d}V\over\mathrm{d}T}={{i\over 2}R\mathrm{d}T+R\mathrm{d}T\over \mathrm{d}T}\\
&={i\over 2}R+R=C_V+R
\end{aligned}
$$
...
&={p_2V_2-p_1V_1\over 1-\gamma}=-\Delta E
\end{aligned}
$$
...
![[大物下/src/13/Pasted image 20220102114549.png]]
