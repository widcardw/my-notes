...
&={Nm\over V}\left({v_{1x}^2+\cdots+v_{Nx}^2\over N}\right)\\
&=nm\overline{v_{x}^2}=\textcolor{red}{{1\over 3}nm\overline{v^2}}\\
&={2\over 3}n({1\over 2}m\overline{v^2})\\
&=\textcolor{red}{{2\over 3}n\overline{\varepsilon_\mathrm{k}}}
\end{aligned}
$$
