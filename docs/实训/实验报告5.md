...
![[public/shixun/Pasted image 20211204093623.png]]

![[public/shixun/Pasted image 20211204093957.png]]
...
![[public/shixun/Pasted image 20211204113621.png]]
...
![[public/shixun/Pasted image 20211204113853.png]]
...
![[public/shixun/Pasted image 20211204114048.png]]
...
![[public/shixun/Pasted image 20211204114145.png]]

#### 2.4.5. 此时 `data` 目录下生成了以下内容

![[public/shixun/Pasted image 20211204114231.png]]

#### 2.4.6. 使用 `jps` 命令，列出以下的进程

![[public/shixun/Pasted image 20211204114258.png]]
...
![[public/shixun/Pasted image 20211204115145.png]]

```bash
export JAVA_HOME=/usr/java/jdk1.8  # java 环境
```

![[public/shixun/Pasted image 20211204115457.png]]

由于在这里我们用的是 JDK8，因此将下面两行注释。

![[public/shixun/Pasted image 20211204115431.png]]

#### 2.5.2. 修改 `HBASE_HOME/conf/hbase-site.xml`

![[public/shixun/Pasted image 20211204115605.png]]

将以下配置写入 `<configuration>` 标签

![[public/shixun/Pasted image 20211204120213.png]]
...
![[public/shixun/Pasted image 20211204120010.png]]

#### 2.6.2. 使用 `jps` 命令，查看 hbase 进程 HMaster 是否运行

![[public/shixun/Pasted image 20211204120319.png]]
...
![[public/shixun/Pasted image 20211204120546.png]]
...
![[public/shixun/Pasted image 20211204131202.png]]
...
![[public/shixun/Pasted image 20211211113331.png]]
...
![[public/shixun/Pasted image 20211204134512.png]]
...
![[public/shixun/Pasted image 20211204134846.png]]
...
![[public/shixun/Pasted image 20211204142019.png]]

![[public/shixun/Pasted image 20211204142048.png]]

![[public/shixun/Pasted image 20211204142122.png]]

```ad-error
title: Error: contacting service. It is probably not running
...
![[public/shixun/Pasted image 20211204142700.png]]
...
![[public/shixun/Pasted image 20211204143231.png]]
...
![[public/shixun/Pasted image 20211204143344.png]]

#### 4.2.4. 配置 regionservers

在 `hbase/conf/` 下创建 `regionservers` 文件，其中写入 hbase 部署的主机名。

![[public/shixun/Pasted image 20211204143550.png]]
...
![[public/shixun/Pasted image 20211210180832.png]]

从机的情况

![[public/shixun/Pasted image 20211210181636.png]]

![[public/shixun/Pasted image 20211210181530.png]]

#### 4.4.2. 访问端口

进入 <https://172.22.0.3:60010/> 中，查看启动情况。

![[public/shixun/Pasted image 20211210181223.png]]
