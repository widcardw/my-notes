...
![[实训/src/Pasted image 20211127095629.png]]
...
![[实训/src/Pasted image 20211127102912.png]]

#### 2.7.2. 双击 `package` 生成 jar 包

![[实训/src/Pasted image 20211127103311.png]]

#### 2.7.3. 将 jar 包上传至虚拟机

![[实训/src/Pasted image 20211127103546.png]]
...
![[实训/src/Pasted image 20211127104303.png]]

![[实训/src/Pasted image 20211127104422.png]]
...
![[实训/src/Pasted image 20211127105544.png]]
...
![[实训/src/Pasted image 20211127115525.png]]

![[实训/src/Pasted image 20211127120400.png]]

![[实训/src/Pasted image 20211127114905.png]]
...
![[实训/src/Pasted image 20211127120626.png]]
...
![[实训/src/Pasted image 20211127123458.png]]

![[实训/src/Pasted image 20211127123530.png]]

![[实训/src/Pasted image 20211127123559.png]]
...
![[实训/src/Pasted image 20211127142227.png]]
...
![[实训/src/Pasted image 20211127150532.png]]

![[实训/src/Pasted image 20211127150638.png]]
...
![[实训/src/Pasted image 20211127164742.png]]
...
![[实训/src/Pasted image 20211127163604.png]]

![[实训/src/Pasted image 20211127163534.png]]

处理完成后可以看到处理后的文件大约为 1.3 MB

![[实训/src/Pasted image 20211127163848.png]]

### 6.3. 下载文件 排序统计

文件下载

![[实训/src/Pasted image 20211127164631.png]]
...
![[实训/src/Pasted image 20211127164437.png]]
