...
![[实训/src/Pasted image 20211120094142.png]]

#### 2.2.2. 选择项目目录，并写入 GroupId，以及项目名称

![[实训/src/Pasted image 20211120091343.png]]

#### 2.2.3. 选择刚刚在 maven settings 中修改的配置

![[实训/src/Pasted image 20211120091817.png]]

#### 2.2.4. 自动下载

![[实训/src/Pasted image 20211204090453.png]]
...
![[实训/src/Pasted image 20211120103837.png]]
...
![[实训/src/Pasted image 20211120143119.png]]
...
![[实训/src/Pasted image 20211126202810.png]]

### 4.2. 克隆虚拟机

本机内存为 8G，因此克隆 2 台从属机，并且使用链接克隆。

![[实训/src/Pasted image 20211120135742.png]]
...
![[实训/src/Pasted image 20211120140614.png]]
...
![[实训/src/Pasted image 20211120145255.png]]
...
![[实训/src/Pasted image 20211120152109.png]]

master 主机上的节点

![[实训/src/Pasted image 20211120150223.png]]

slave 从机上的数据节点

![[实训/src/Pasted image 20211120150337.png]]

#### 4.4.5. 运行测试程序

回到 IDEA，运行刚才写的程序。在 `172.22.0.3:50070` 端可以看到上传的文件，有多个副本 (Replication)。

![[实训/src/Pasted image 20211120150905.png]]
